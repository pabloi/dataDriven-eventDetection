...
\begin{frame}{Implementation}
    \begin{itemize}
        ...
        \end{itemize}
        \item Evaluation of algorithm performance:
        \begin{itemize}
            \item Correctly predicted events: $t_{\mathrm{true}} - t_{\mathrm{pred}}$
            \item Gross mis-prediction: total time of mispredicted state
        \end{itemize}
        \item Further work:
        \begin{itemize}
