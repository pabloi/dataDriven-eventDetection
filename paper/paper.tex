...
shows a repeating pattern in which the toe off event is marked by a global
...
strike.
By using a constraint on the heel strike time, 
select the one that satisfies the constraint
