...
\title
{
    ...
    \titlenote
    {
        ...
        Research Laboratory and its PI, Dr.~Gelsy Torres-Oviedo, for granting
        us the permission to use their experimental data in this paper.
        The collection of this data was approved by the university's
        Institutional Review Board.
        All participants gave prior consent to the use of their data for
        research purposes.
    }
}
...
We use the term ``heuristic approach'' to describe algorithms that detect motion
events based on heuristics such as
...
seemingly simple, no training, no learning
