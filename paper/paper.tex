...
This fact can be explained by the ease of implemention it offers:
it does not require any data preprocessing beyond simple signal processing and
the algorithm does not have to be trained.
...
the window size is not fixed but varies as a function of
...
Moreover, the network architecture seems to be oversimplistic to effectively
